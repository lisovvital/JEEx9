	...
	<form method="POST" action="save">
		<table class="table">
			...
			<tr>
				...
				<td>${vm.book.id}<input type="hidden" value='${vm.book.id}'
					name="hdnBookId" /></td>
			</tr>
			<%
			}
			...
			<tr>
				<td>Book Name:</td>
				<td><input type="text" name="bookName" value='${vm.book.name }' /></td>
			</tr>
			<tr>
				<td>Book Price:</td>
			...
			<tr>
				...
				<td>
					...
					%> <input
					type="radio" name="bookTerm" value="<%=i%>" checked />Term<%=i%>
					<%
					} else {
					%> <input type="radio" name="bookTerm" value="<%=i%>" />
					Term<%=i%> <%
 }
 }
